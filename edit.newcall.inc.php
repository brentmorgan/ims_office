...
function listCalls(){
	...
	foreach($another_call_list as $row){ 
     ...
     // ********************* THE URL TO EDIT AN ENTRY WILL NEED TO BE CHANGED!!!!! (LOOSE THE EDIT. AT THE START!!!!!!
		$list .= "<tr id='row_num_" . $row['id'] . "'><td id='edit_" . $row['id'] . "'><a href='edit.editcall.php?id=" . $row['id'] . "'>Edit</a></td><td>" . $row['datecreated'] . "</td><td>" . $row['reported_by'] . "</td><td> " . $row['room_id'] . "</td><td>" . $row['resolved_phone'] . "</td><td id='problem_" . $row['id'] . "'>" . $problem . "</td><td>" . $row['send_tech'] . "</td><td id='solved_" . $row['id'] . "'>" . $row['solved_tech'] . "</td><td>" . $confirm . "</td><td id='rt_" . $row['id'] . "'>" . $rt . "</td></tr>";
	}
	$list .= "</table>";
