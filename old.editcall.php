...
<?php 
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		print "<form name='boxes' method='post' action='newcalllist.php'>";
		...
		print "<br />";
		$list =  "<br />Resolved over phone: <input type='radio' name='resolved_phone' value='yes' ";
		...
		$list = "<br />Type of problem: <input type='radio' name='user_error' value='yes' onClick='Effect.SlideDown(\"checklist\")' ";
		...
		$list .= " />Equipment Failure <input type='radio' name='user_error' value='unsure' onClick='document.getElementById(\"checklist\").style.display=\"none\"'  ";
		...
		$list = "<br />Sending a Technician? <input type='radio' name='send_tech' value='office' onClick='Effect.SlideDown(\"tech_solved_div\")' ";
		...
		$list = "<div id='tech_solved_div' style='display:" . $vis_tech . "' >Technician solved the problem? <input type='radio' name='solved_tech' value='yes' ";
		...
		$list = "RT Ticket? <input type='radio' name='rt_ticket' value='yes' onClick='document.getElementById(\"rt_ticket_number\").style.display=\"\"' ";
