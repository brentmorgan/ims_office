...
if ($_POST) {
	...
	if (isset($_POST['edit'])) { // ***************** EDITING AN OLD SUPPORT CALL
		$sql = "UPDATE calls SET resolved_phone='$_POST[resolved_phone]', user_error='$_POST[user_error]', send_tech='$_POST[send_tech]', solved_tech='$_POST[solved_tech]', rt_ticket='$_POST[rt_ticket]', ticket_num='$_POST[ticket_num]' WHERE id = '$_POST[id]'";
