    ...
    */
    RGraph.Line.prototype.DrawLine = function (lineData, color, fill)
    {
        ...
        for (i=0; i<lineData.length; i++) {
            ...
            yPos  = this.canvas.height - ( (lineData[i] / this.max) * ((this.canvas.height - (2 * this.gutter)) ));
        ...
        for (var i=0; i< lineCoords.length; ++i) {
            ...
            if (i == 0 || penUp || !yPos || !prevY) {
                if (this.Get('chart.filled') && !this.Get('chart.filled.range')) {
                    this.context.moveTo(xPos + 1, this.canvas.height - this.gutter - (this.Get('chart.xaxispos') == 'center' ? (this.canvas.height - (2 * this.gutter)) / 2 : 0) );
    ...
    */
    RGraph.Line.prototype.DrawTick = function (xPos, yPos, color, isShadow, prevX, prevY)
    {
        ...
        */
            ...
            this.context.beginPath();
                this.context.moveTo(xPos, yPos);
                this.context.arc(xPos, yPos, 7, a - 0.499999, a - 0.500001, false);
