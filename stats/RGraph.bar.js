    ...
    RGraph.Bar.prototype.Drawbars = function ()
    {
        ...
        */
        for (i=0; i<this.data.length; ++i) {
            ...
            var y      = this.Get('chart.xaxispos') == 'center' ? (this.canvas.height / 2) - height : this.canvas.height - height - gutter;
            ...
            this.context.beginPath();
                ...
                */
                    ...
                    for (j=0; j<this.data[i].length; ++j) {
                        ...
                        var totalHeight = (RGraph.array_sum(this.data[i]) / this.max) * (this.canvas.height - this.Get('chart.hmargin') - (2 * this.gutter));
                ...
                */
                    ...
                    for (j=0; j<this.data[i].length; ++j) {
                        ...
                        var startY = (this.Get('chart.xaxispos') == 'bottom' ? this.canvas.height : (this.canvas.height / 2) + this.gutter) - this.gutter - height;
