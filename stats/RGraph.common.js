    ...
    RGraph.Tooltip = function (canvas, text, x, y)
    {
        ...
        */
        ...
        for (var i=0; i<links.length; ++i) {
            links[i].onmousedown = function () {location.href = this.href;};
        }
    ...
    RGraph.Zoom = function (e)
    {
        ...
        */
        ...
        if (obj.Get('chart.zoom.shadow')) {
            for (var i=1; i<=frames; ++i) {
                setTimeout("RGraph.Registry.Get('chart.zoomedimage').style.boxShadow = 'rgba(0,0,0," + Number(i / frames) / 2 + ") 3px 3px 3px'", i * delay);
    ...
    */
    ...
    {
        RGraph.FixEventObject(document.all ? event : e);
